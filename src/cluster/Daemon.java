...
//simulation run on 8 core Virtual machine
public class Daemon {
...
/* old version
	...
	public static void main(String[] args) {
		...
		for(int m=0; m<20; m++)
		{
			//for(int i=0;i<9;i++)
			//{
			  tom.newWorkflow("a",16, 150000, 1, 100);

			//}
			//for(int i=0;i<9;i++)
			//{
			  tom.newWorkflow("b",16, 150000, 1, 1000);
			//}
		}
		...
		Daemon.theserver.viewSummary();
		Daemon.theserver.viewSummaryByType("a");
		Daemon.theserver.viewSummaryByType("b");
