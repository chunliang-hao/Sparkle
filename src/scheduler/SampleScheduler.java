...
public class SampleScheduler extends BasicScheduler implements Observer{

	private int proberatio;
	private Server theserver;
	private Object lock;
	
	public SampleScheduler(Server server, int pr)
	{
	...
	public void update(Observable o, Object arg) {
		if(o instanceof JobQueue && arg instanceof List){
			do{
				Decision dec = this.MakeDecision(this.theserver.getConnectedClients(),(List)arg);
				this.theserver.scheduleonetask(dec);
			}while(((List)arg).size()>0);
		}
